...
class Program
{
    static void Main()
    {
        ...
        {
            string raw_segments = GetFiles($"/Users/mohamedanwershah/Downloads/.zenbridge/std/X12/{curr_ver}/Sets");
        ...
        WriteAllText("output_sets.json", json);
    }
    ...
    static string GetSha(string filename, string version)
    {
        var psi = new ProcessStartInfo
        {
            ...
            Arguments = $"-c \"dhall hash --file /Users/mohamedanwershah/Downloads/.zenbridge/std/X12/{version}/Sets/{filename}\"",
            UseShellExecute = false,
            CreateNoWindow = false,
            RedirectStandardOutput = true,

            WorkingDirectory = $"/Users/mohamedanwershah/Downloads/.zenbridge/std/X12/{version}/Sets"
        };
